...
import doctorImage from "@/assets/doctor-medical-blue.jpg";

const MedicalClinicBlue = () => {
  const navItems = [
  ...
  const doctors = [
    { name: "Dr. Yuvaraj", specialty: "General Medicine" },
    { name: "Dr. Priya Sharma", specialty: "Cardiology" },
    { name: "Dr. Rakesh Mehta", specialty: "Internal Medicine" },
  ];
  ...
  const doctorProfiles = [
    {
      ...
      about: "Dr. Yuvaraj is a distinguished internal medicine specialist and the founder of our clinic. With over two decades of experience, he has dedicated his career to providing comprehensive healthcare with a focus on preventive medicine and patient education.",
  ...
  return (
    <div className="theme-blue min-h-screen">
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">
              Book Appointment With your Physician
            </h2>
            <p className="text-primary-foreground/90 text-lg">
              Our experienced team of medical professionals is committed to providing you with the highest quality care.
            </p>
          </div>
      ...
      <AppointmentBooking
        ...
        subtitle="Schedule your consultation with our medical experts"
        doctors={doctors}
        theme="blue"
      />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              <div key={index} className="healthcare-card p-6 text-center">
                ...
                <p className="text-sm text-muted-foreground">Expert medical care with personalized treatment plans</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <footer className="bg-primary text-primary-foreground py-8">
        <div className="container mx-auto px-4 text-center">
          <h3 className="text-xl font-semibold mb-2">Dr. Yuvaraj Clinic</h3>
          <p className="text-primary-foreground/80">
            Comprehensive medical care with a focus on prevention and wellness
          </p>
        </div>
      </footer>
    </div>
...
export default MedicalClinicBlue;