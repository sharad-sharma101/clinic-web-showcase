    ...
    extend: {
      colors: {
        ...
        healthcare: {
          ...
          "green-dark": "hsl(var(--healthcare-green-dark))",
          "green-light": "hsl(var(--healthcare-green-light))",
          orange: "hsl(var(--healthcare-orange))",
          "orange-dark": "hsl(var(--healthcare-orange-dark))",
          "orange-light": "hsl(var(--healthcare-orange-light))",
          brown: "hsl(var(--healthcare-brown))",
          "brown-dark": "hsl(var(--healthcare-brown-dark))",
          "brown-light": "hsl(var(--healthcare-brown-light))",
        },
      },
      borderRadius: {
        lg: "var(--radius)",
